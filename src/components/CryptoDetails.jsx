...
const CryptoDetails = () => {
  ...
  const stats = [
    ...
    { title: '24h Volume', value: `$ ${cryptoDetails && millify(Number(cryptoDetails['24hVolume']))}`, icon: <ThunderboltOutlined /> },
      ...
      <Col className='stats-container'>
        <Col className='coin-value-statistics'>
          <Col className='coin-value-statistics-heading'>
            ...
            <p>
              An overview showin the statistics of {cryptoDetails.name}
            </p>
          </Col>
        ...
        <Col className='other-stats-info'>
          <Col className='coin-value-statistics-heading'>
            ...
            <p>
              An overview showin other statistics 
            </p>
          </Col>
